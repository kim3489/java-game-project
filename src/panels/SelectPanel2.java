...
public class SelectPanel2 extends JPanel {
    ...
    private JButton ch1_2;
	private JButton ch2_2;
	private JButton ch3_2;
	private JButton ch4_2;
	...
	private CookieImg[] ci = new CookieImg[2];
	...
	public SelectPanel2(Object o) {

		
		// 시작 버튼
		StartBtn = new JButton(start);
		StartBtn.setName("StartBtn2");
		StartBtn.addMouseListener((MouseListener) o);
		StartBtn.setBounds(254, 420, 291, 81);
		add(StartBtn);
		...
		ch1.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				ch3.setIcon(ch03);
				ch4.setIcon(ch04);
				ci[0] = new CookieImg(new ImageIcon("img/cookieimg/cookie1/player_origin.gif"),
		...
		ch2.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				ch3.setIcon(ch03);
				ch4.setIcon(ch04);
				ci[0] = new CookieImg(new ImageIcon("img/cookieimg/cookie2/normal.gif"),
		...
		ch3.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				ch3.setIcon(ch033);
				ch4.setIcon(ch04);
				ci[0] = new CookieImg(new ImageIcon("img/cookieimg/cookie3/cookie.gif"),
		...
		ch4.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				ch3.setIcon(ch03);
				ch4.setIcon(ch044);
				ci[0] = new CookieImg(new ImageIcon("img/cookieimg/cookie4/kch.gif"),
        ...
        // 캐릭터 ch1_2
		ch1_2 = new JButton(ch01);
		ch1_2.setName("ch1_2");
		ch1_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				ch1_2.setIcon(ch011);
				ch2_2.setIcon(ch02);
				ch3_2.setIcon(ch03);
				ch4_2.setIcon(ch04);
				ci[1] = new CookieImg(new ImageIcon("img/cookieimg/cookie1/player_origin.gif"),
						new ImageIcon("img/cookieimg/cookie1/player_up.gif"),
						new ImageIcon("img/cookieimg/cookie1/player_doubleup.gif"),
						new ImageIcon("img/cookieimg/cookie1/player_jumpend.png"),
						new ImageIcon("img/cookieimg/cookie1/player_down.gif"),
		...
		ch1_2.setBounds(90, 562, 150, 200);
		add(ch1_2);
		ch1_2.setBorderPainted(false);
		ch1_2.setContentAreaFilled(false);
		ch1_2.setFocusPainted(false);

		// 캐릭터 ch2_2
		ch2_2 = new JButton(ch02);
		ch2_2.setName("ch2_2");
		ch2_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				ch1_2.setIcon(ch01);
				ch2_2.setIcon(ch022);
				ch3_2.setIcon(ch03);
				ch4_2.setIcon(ch04);
				ci[1] = new CookieImg(new ImageIcon("img/cookieimg/cookie2/normal.gif"),
						new ImageIcon("img/cookieimg/cookie2/jump.gif"),
						new ImageIcon("img/cookieimg/cookie2/doublejump.gif"),
						new ImageIcon("img/cookieimg/cookie2/fall.png"),
						new ImageIcon("img/cookieimg/cookie2/slide.gif"),
		...
		ch2_2.setBounds(238, 562, 150, 200);
		add(ch2_2);
		ch2_2.setBorderPainted(false);
		ch2_2.setContentAreaFilled(false);
		ch2_2.setFocusPainted(false);

		// 캐릭터 ch3
		ch3_2 = new JButton(ch03);
		ch3_2.setName("ch3");
		ch3_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				ch1_2.setIcon(ch01);
				ch2_2.setIcon(ch02);
				ch3_2.setIcon(ch033);
				ch4_2.setIcon(ch04);
				ci[1] = new CookieImg(new ImageIcon("img/cookieimg/cookie3/cookie.gif"),
						new ImageIcon("img/cookieimg/cookie3/jump.png"),
						new ImageIcon("img/cookieimg/cookie3/doublejump.gif"),
						new ImageIcon("img/cookieimg/cookie3/fall.png"),
						new ImageIcon("img/cookieimg/cookie3/slide.gif"),
		...
		ch3_2.setBounds(386, 562, 150, 200);
		add(ch3_2);
		ch3_2.setBorderPainted(false);
		ch3_2.setContentAreaFilled(false);
		ch3_2.setFocusPainted(false);

		// 캐릭터 ch4
		ch4_2 = new JButton(ch04);
		ch4_2.setName("ch4");
		ch4_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				ch1_2.setIcon(ch01);
				ch2_2.setIcon(ch02);
				ch3_2.setIcon(ch03);
				ch4_2.setIcon(ch044);
				ci[1] = new CookieImg(new ImageIcon("img/cookieimg/cookie4/kch.gif"),
						new ImageIcon("img/cookieimg/cookie4/kjump.gif"),
						new ImageIcon("img/cookieimg/cookie4/kjump.gif"),
						new ImageIcon("img/cookieimg/cookie4/kjump.gif"),
						new ImageIcon("img/cookieimg/cookie4/kslide.gif"),
		...
		ch4_2.setBounds(534, 562, 150, 200);
		add(ch4_2);
		ch4_2.setBorderPainted(false);
		ch4_2.setContentAreaFilled(false);
		ch4_2.setFocusPainted(false);
        ...
        // 배경2
		JLabel selectBg2 = new JLabel("");
		selectBg2.setForeground(Color.ORANGE);
		selectBg2.setHorizontalAlignment(SwingConstants.CENTER);
		selectBg2.setIcon(new ImageIcon("img/select/selectBg.png"));
		selectBg2.setBounds(0, 460, 784, 461);
		add(selectBg2);
